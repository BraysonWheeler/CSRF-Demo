...
from jwt_utility import generate_jwt
...
# Used for CORS Preflight. Not Necessary unless CSRF involves request that force CORS Preflight.
# malicious.html uses form requests which dont require CORS preflight.
# uncomment if you want to use fetch() or xhr()
# @app.options("/profile/change-email-vulnerable")
# async def cors_pre_flight(response:Response):
#     response.headers.append("Access-Control-Allow-Origin","*")
#     response.headers.append("Access-Control-Allow-Methods", "POST")
#     response.headers.append("Access-Control-Allow-Headers", "content-type")
#     response.headers.append("Access-Control-Allow-Headers", "_jwt")
#     return
